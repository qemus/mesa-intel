...
Run QEMU OpenGL and QXL on headless Debian hosts without installing an Xorg server or desktop environment.
...
and conflicts with/replaces Debian's stock packages with those names. On a headless host, this lets Debian's official QEMU modules satisfy their normal runtime dependencies without installing the broader stock Mesa Gallium/LLVM and SPICE multimedia runtime stacks.
